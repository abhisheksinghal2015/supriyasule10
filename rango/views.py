...
def editview(request):
    if request.POST:
        ...
        c.taluka = taluka.objects.get(t__icontains=request.POST.get('taluka'))
        ...
        c.complaint_type = comp_type.objects.get(type__icontains=request.POST.get('complaint_type'))
